# The Everglades collapse — swamp eels and the window that lets small things grow

- format: 1920x1080
- duration: 734.08s
- profile: explainer-punchy
- audio: assets/audio/narration.mp3
- intensity: grade/vignette/motion/punch/overlays/transitions = strong; sfx = off; music = off
...
- narration: they're no longer bite-sized. That window is not a nice bonus.
...
- narration: It is the engine. It is the reason the Everglades could support the enormous wading bird colonies it was historically famous for.
...
- narration: The swamp eel doesn't need the deep water. It breeds air, so a drying pool is not a death sentence.
...
- overlay: keyword-flash at middle-left, fade entrance
- narration: And when it does get too dry, it burrows into the same mud, in the same shallows, alongside the same small animals that were counting on those months of peace.
...
- overlay: title-card at middle-center, fade entrance
- narration: The window never opens, and that is why the tree frogs are still calling in Taylor Slough while nothing calls from the water.
...
- narration: Those are not incidental animals. In the everglades, they are the currency.
...
- overlay: keyword-flash at middle-left, fade entrance
- narration: Take them out and you have not removed a species. You have removed the layer that everything else is standing on.
...
- query: swamp at dawn mist over water
- overlay: title-card at middle-left, fade entrance
- narration: Honestly, very little. And not because anyone is being negligent, because the tools don't exist.
...
- query: burrow hole wet mud closeup
- overlay: keyword-flash at middle-right, fade entrance
- narration: Swamp eels are small, live in mud, occupy a wetland the size of a small state, and there is no plausible number of people you could pay to make a
...
- narration: And the front line is not only inside the Everglades. The species is established in Georgia.
...
- narration: Not the top. The bottom. The layer everything else stands on.
