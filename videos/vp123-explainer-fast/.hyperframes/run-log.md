...
4 devices (5.5/min) from template explainer-fast
  - **title-card:** 3
  - **info-card:** 1
  - **dropped:** 1
...
Picked transition sequence for 8 beat(s)
  ...
  - **sequence:** cut, hard-cut 0s, hard-cut 0s, paper-tear 0.35s, hard-cut 0s, crossfade 0.3s, light-leak-flash 0.5s, hard-cut 0s
...
beat 06: frame built [video, kenburns=none]
  - **overlay:** info-card
  - **overlay params:** {"title":"whatever black","bullets":["The black sky","The stars","Whatever fire they kept alive"],"kicker":"","marker":"check","placement":"middle-right"}
...
beat 07: frame built [video, kenburns=none]
  - **overlay:** title-card
  - **overlay params:** {"title":"So what did they do?","kicker":"Part 3","placement":"lower-center"}
  - **overlay enterAt:** 0.2s
  - **cutaway:** n/a
  - **parallax:** n/a
  - **punch-in:** 3.25s ×1.3
...
8 frames built from the explainer-fast template plan
  - **failed:** none
  - **skipped:** 0
